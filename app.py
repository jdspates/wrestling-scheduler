...
import json# app.py – DRAG REORDER + WRESTLER 2 CURRENT + ADD TO MAT + YELLOW HIGHLIGHT
import streamlit as st
import pandas as pd
import io
import random
...
if st.session_state.initialized:
    ...
    for mat in range(1, CONFIG["NUM_MATS"]+1):
        ...
        with st.expander(f"Mat {mat}", expanded=is_open):
            # Wrap in div for data-mat
            st.markdown(f'<div data49-mat="{mat}">', unsafe_allow_html=True)
